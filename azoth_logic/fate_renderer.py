...
class FateRenderer:
    ...
    Named RitualRenderer until 2026-08-26. Rituals were the precursor to
    Aspects; the *table* and its commands are gone, but this renderer was never
    ritual-specific and is what aspects.py and events.py have always used.
    (Rituals in Azoth today are the game's difficulty levels, an entirely
    different concept -- see docs/AZOTH.md.)
    """
